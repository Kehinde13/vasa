...
import { FaHome, FaInbox, FaUsers, FaClipboardList, FaFileAlt, FaCalendarAlt, FaCreditCard, FaCog, FaTrash, FaToolbox, FaSignOutAlt } from "react-icons/fa";
    ...
    <aside className="hidden md:flex fixed top-0 left-0 h-screen w-64 dark:bg-gray-800 dark:text-white bg-[#F0F0F0] shadow-lg flex-col justify-between z-30">
      <div>
        <div className="p-6 flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 dark:text-white flex items-center justify-center text-lg font-bold text-gray-700">
